...
<body class="bg-transparent dark:text-white max-sm:w-screen max-sm:h-screen max-sm:overflow-x-clip">
    ...
    <div class="absolute max-sm:invisible max-sm:h-0 max-sm:w-0 reg-bg h-screen w-screen z-10"></div>
    <div
        class="max-sm:-translate-x-full sm:translate-x-full duration-200 reg h-screen sm:w-152 max-sm:w-screen absolute mt-0 p-0 z-30 right-0 bg-white dark:bg-darkgrayl max-sm:block max-sm:justify-center overflow-y-scroll">
        <div class="p-10">
            <div
    ...
    <div class="sm:mx-16 sm:pt-16 max-sm:pt-8">
        ...
        <div class="flex sm:invisible sm:h-0 sm:w-0 max-sm:w-screen justify-center items-center">
            <form action="" class="sm:invisible sm:h-0 search-form h-10 flex w-full justify-center items-center bg-redd">
        ...
        <div class="stable flex justify-center">
            <div class="sm:mt-8 flex max-sm:flex-col">
                <div class="max-sm:w-screen max-sm:flex max-sm:justify-center">
                    <div class="users-table sm:mt-8 max-sm:h-[calc(100vh-324px)] max-sm:overflow-x-scroll p-7 shadow-xl sm:mr-5 sm:rounded-3xl max-sm:rounded-xl bg-white dark:bg-darkgrayl duration-500 max-sm:mx-5">
                            ...
                            <form id="form" action="#" method="post">
                                <tr class="flex border-b sm:gap-15" tabindex="1">
                                    <td class="flex justify-center items-center mr-5">
                                        <input name="checkrow" value="" type="checkbox" class="listcheck dark:accent-darkredd"
                                               onclick="checkchecks()" onchange="checkdbrow(this)">

                                    </td>
                                    <td class="w-16 h-12 mr-5 rounded flex justify-center items-center text-xl"></td>
                                    <td class="w-40 h-12 mr-5 rounded flex justify-center items-center text-xl">
                                    </td>
                                    <td class="w-40 h-12 mr-5 rounded flex justify-center items-center text-xl"></td>
                ...
                <div class="">
                    <div class="max-sm:w-screen max-sm:flex max-sm:justify-center max-sm:mt-0 max-sm:p-0">
                        <div class="max-sm:w-full max-sm:p-3 shadow-xl rounded-xl bg-white dark:bg-darkgrayl px-3 max-sm:m-5 max-sm:mb-0">
                    ...
                    <div class="max-sm:h-fit max-sm:w-full flex justify-center items-center">
                        <div
                        class="export-formats shadow-xl z- dark:bg-darkgrayl rounded-xl h-0 w-full mt-2 top-20 duration-500 flex justify-center items-center overflow-hidden gap-3 dark:bg-darkgrayl max-sm:mx-5">
                        <button
